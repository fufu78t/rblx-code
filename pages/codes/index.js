...
// Universe IDs Roblox pour les thumbnails officiels
const UNIVERSE_IDS = {
...
// Dégradés de fallback par catégorie
const CAT_COLORS = {
...
// Charge les icônes officielles Roblox en batch via l'API publique
function useRobloxThumbnails(gameList) {
  ...
  useEffect(() => {
    ...
    fetch(
      ...
      .catch(() => {}) // fallback dégradé utilisé silencieusement
  }, [])
